...
#define SDRAM_SIZE            (  ( 8 * 1024 * 1024) + 128 )
#define SDRAM_BASE            0x60000000
#define MEM_START_ADDRESS     { ( void* )end, ( void* )DSRAM2_BASE, ( void* )PSRAM_BASE, ( void * )SDRAM_BASE }
#define MEM_END_ADDRESS       { ( void* )( DSRAM1_BASE + DSRAM1_SIZE - STACK_SIZE_TOTAL - 1 ), ( void* )( DSRAM2_BASE + DSRAM2_SIZE - 1 ), ( void* )( PSRAM_BASE + PSRAM_SIZE - 1 ), ( void * )( SDRAM_BASE + SDRAM_SIZE ) }
